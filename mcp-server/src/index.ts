    ...
    tools: [
      {
        name: "add_prompt",
        description:
          "Add a prompt to the AI Library. Prompts are reusable text templates for AI interactions.",
        inputSchema: {
          type: "object",
          properties: {
            title: {
      ...
      },
      {
        name: "add_skill",
        description:
          "Add a skill to the AI Library. Skills are packaged capabilities (like Cursor skills) distributed as archive files.",
        inputSchema: {
          type: "object",
          properties: {
            title: {
            ...
            skillUrl: {
              type: "string",
              description:
                "URL to the skill archive file (.zip, .tar.gz, etc.)",
            },
            summary: {
              type: "string",
      ...
      },
      {
        name: "add_context",
        description:
          "Add a context document to the AI Library. Context documents provide reference information for AI tools.",
        inputSchema: {
          type: "object",
          properties: {
            title: {
      ...
      },
      {
        name: "add_build",
        description:
          "Add a build to the AI Library. Builds are links to applications, tools, or resources built with AI.",
        inputSchema: {
          type: "object",
          properties: {
            title: {
